...
/**
 * Defines an interface for a generalized hypermedia link, primarily containing a 'rel' (relationship name) and 'href'
 * (a URL to the related resource). Additionally, it implements Cloneable and can contain arbitrary string-value
 * properties. Hence, the 'generalized' term in use above.
 *
 * @author toddf
 * @since  Apr 3, 2014
 */
public interface Link extends Cloneable {
    ...
    /**
     * Set the value of an arbitrary property on this link by name. As different linking styles support different
     * properties, this 'generalized' link interface supports them all by allowing the consumer to set any property name
     * to a string value.
     *
     * <p/>If the property name is already present the value will be overwritten.
     *
    ...
    /**
     * Retrieve the value of an arbitrary property from this link. Or null, if the property is not present.
     *
    ...
    /**
     * Answer whether the link href contains any URL tokens (e.g. of the form '{tokenName}'). If 'true' is returned,
     * this indicates that the URL is not fully populated.
     *
    ...
    /**
     * Create a matching copy of this link instance. The returned instance is new, with copies of the properties.
     *
