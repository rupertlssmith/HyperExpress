...
public class HyperExpressTest {
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        HyperExpress.relationships()
            .addNamespaces(new Namespace("ea", "http://namespaces.example.com/{rel}"),
            ...
            .rel(NEXT, "/blogs?limit={nextLimit}&offset={nextOffset}")
            .optional()
            .rel(PREV, "/blogs?limit={prevLimit}&offset={prevOffset}")
            .optional()
            ...
            .ifBound("{adminRole}")
            .rels(ALTERNATE, "/blogs/{blogId}/entries/{entryId}")
            .optional()
    ...
    public void shouldContainOptionalQueryStringParameters() {
        HyperExpress.bind("selfOffset", "40").bind("selfLimit", "20");
    ...
    public void shouldContainOptionalLinks() {
        HyperExpress.bind("nextOffset", "40").bind("nextLimit", "20");
    ...
    public void shouldContainOptionallyBoundLinksWithString() {
        HyperExpress.bind("adminRole", "admin").bind("blogId", "42").bind("entryId", "33");
    ...
    public void shouldContainOptionalLinksWithMultipleBindings() {
        HyperExpress.bind("adminRole", "admin").bind("superUser", "true");
